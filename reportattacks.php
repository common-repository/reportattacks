...
define('REPORTATTACKSVERSION', '2.32' );
...
if(is_admin() and current_user_can("manage_options")){
  if (!class_exists('Bill_Class_Diagnose')) {
      $plugin_slug = "reportattacks"; // Replace with your actual text domain
      $plugin_text_domain = "reportattacks"; // Replace with your actual text domain
      $notification_url = "https://wpmemory.com/fix-low-memory-limit/";
      $notification_url2 =
          "https://wptoolsplugin.com/site-language-error-can-crash-your-site/";
      require_once(REPORTATTACKSPATH . "includes/checkup/bill_class_diagnose.php");
  }
}

if( !function_exists('bill_my_custom_require_once')){
      function bill_my_custom_require_once() {
          if (! class_exists('bill_catch_errors'))
          require_once(REPORTATTACKSPATH . "includes/checkup/class_bill_catch_errors.php");
      }
      add_action('plugins_loaded', 'bill_my_custom_require_once');
}
